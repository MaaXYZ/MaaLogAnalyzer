...
const makeActionDetails = (params: { actionId: number; name: string; success: boolean }) => ({
...
describe('LogParser strict public snapshots', () => {
  it('projects non-realtime image links for failed nodes, recognitions, and wait_freezes', async () => {
    const lines = [
      ...
      makeEventLine(5, 'Node.WaitFreezes.Starting', {
        task_id: 81,
        wf_id: 81,
        phase: 'pre',
        name: 'ImageNode',
      }),
      makeEventLine(6, 'Node.WaitFreezes.Succeeded', {
        task_id: 81,
        wf_id: 81,
        phase: 'post',
        elapsed: 12,
      ...
      makeEventLine(8, 'Tasker.Task.Failed', {
        task_id: 81,
        entry: 'ImageTask',
        hash: 'h-image',
        uuid: 'u-image',
    ...
    parser.setVisionImages(
      new Map([['2026.04.07-10.00.00.004_ImageReco_81001', '/fixtures/reco-vision.png']]),
    )
    parser.setWaitFreezesImages(
      new Map([['2026.04.07-10.00.00.006_ImageNode_wait_freezes', '/fixtures/wait-freezes.png']]),
    )
  ...
  it('keeps explicit scope structure for recognition, action node, task, and wait_freezes', async () => {
    const lines = [
      ...
      makeEventLine(6, 'Tasker.Task.Starting', {
        task_id: 72,
        entry: 'SubTask',
        hash: 'h-sub-72',
        uuid: 'u-sub-72',
      }),
      makeEventLine(7, 'Node.PipelineNode.Starting', {
        task_id: 72,
        node_id: 7201,
        name: 'SubNode',
      }),
      makeEventLine(8, 'Node.WaitFreezes.Starting', {
        task_id: 72,
        wf_id: 72,
        phase: 'pre',
        name: 'SubNode',
      }),
      makeEventLine(9, 'Node.WaitFreezes.Succeeded', {
        task_id: 72,
        wf_id: 72,
        phase: 'post',
        elapsed: 10,
      ...
      makeEventLine(10, 'Node.Action.Starting', {
        task_id: 72,
        action_id: 72001,
        name: 'SubAction',
      }),
      makeEventLine(11, 'Node.Action.Succeeded', {
        task_id: 72,
        action_id: 72001,
        name: 'SubAction',
      }),
      ...
      makeEventLine(15, 'Tasker.Task.Succeeded', {
        task_id: 72,
        entry: 'SubTask',
        hash: 'h-sub-72',
        uuid: 'u-sub-72',
      }),
      makeEventLine(16, 'Node.WaitFreezes.Starting', {
        task_id: 71,
        wf_id: 71,
        phase: 'repeat',
        name: 'MainNode',
      }),
      makeEventLine(17, 'Node.WaitFreezes.Failed', {
        task_id: 71,
        wf_id: 71,
        phase: 'repeat',
        elapsed: 33,
      ...
      makeEventLine(18, 'Node.Action.Starting', {
        task_id: 71,
        action_id: 71001,
        name: 'MainAction',
      }),
      makeEventLine(19, 'Node.Action.Failed', {
        task_id: 71,
        action_id: 71001,
        name: 'MainAction',
      }),
      ...
      makeEventLine(23, 'Tasker.Task.Failed', {
        task_id: 71,
        entry: 'MainTask',
        hash: 'h-main-71',
        uuid: 'u-main-71',
    ...
    expect(mainNode.next_list).toEqual([{ name: 'MainCandidate', anchor: false, jump_back: false }])
  ...
  it('ignores unknown phases while keeping multi-level task nesting', async () => {
    const lines = [
      ...
      makeEventLine(104, 'Tasker.Task.Starting', {
        task_id: 22,
        entry: 'SubTaskL1',
        hash: 'h-sub-l1',
        uuid: 'u-sub-l1',
      }),
      makeEventLine(105, 'Node.PipelineNode.Starting', {
        task_id: 22,
        node_id: 2201,
        name: 'SubNodeL1',
      }),
      makeEventLine(106, 'Tasker.Task.Starting', {
        task_id: 23,
        entry: 'SubTaskL2',
        hash: 'h-sub-l2',
        uuid: 'u-sub-l2',
      }),
      makeEventLine(107, 'Node.PipelineNode.Starting', {
        task_id: 23,
        node_id: 2301,
        name: 'SubNodeL2',
      }),
      makeEventLine(108, 'Node.PipelineNode.Succeeded', {
        task_id: 23,
        node_id: 2301,
        name: 'SubNodeL2',
      }),
      makeEventLine(109, 'Tasker.Task.Succeeded', {
        task_id: 23,
        entry: 'SubTaskL2',
        hash: 'h-sub-l2',
        uuid: 'u-sub-l2',
      }),
      makeEventLine(110, 'Tasker.Task.Custom', {
        task_id: 22,
        entry: 'SubTaskL1',
        hash: 'h-sub-l1',
        uuid: 'u-sub-l1',
      ...
      makeEventLine(113, 'Node.PipelineNode.Succeeded', {
        task_id: 21,
        node_id: 2101,
        name: 'MainNode',
      }),
      makeEventLine(114, 'Tasker.Task.Succeeded', {
        task_id: 21,
        entry: 'MainTask',
        hash: 'h-main-3',
        uuid: 'u-main-3',
  ...
  it('reuses completed task projections across realtime snapshots', async () => {
    ...
    await parser.parseFile(
      [
        ...
        makeEventLine(202, 'Tasker.Task.Succeeded', {
          task_id: 31,
          entry: 'Completed',
          hash: 'h-31',
          uuid: 'u-31',
    ...
    parser.appendRealtimeLines([
      makeEventLine(203, 'Tasker.Task.Starting', {
        task_id: 32,
        entry: 'Running',
        hash: 'h-32',
        uuid: 'u-32',
